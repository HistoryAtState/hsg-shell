        ...
        <div id="catalog">
            ...
            return
                ...
                <div id="{$vol-id}">
                    ...
                    <p>Ebook last updated: {xsl:format-dateTime(xs:dateTime(fh:ebook-last-updated($vol-id)), 'MMMM D, YYYY', 'en', (), 'US')}</p>
...
declare function fh:frus-history-ebook-entry($model as map(*)) {
    ...
    let $s3-base-url := concat('//', $config:S3_DOMAIN, '/', $vol-id)
    ...
    return
        <div id="frus-history">
            ...
            <p>Ebook last updated: {xsl:format-dateTime(xs:dateTime($last-updated), 'MMMM D, YYYY', 'en', (), 'US')}.</p>
            <ul class="hsg-ebook-list">
