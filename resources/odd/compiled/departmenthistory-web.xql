...
module namespace model="http://www.tei-c.org/tei-simple/models/departmenthistory.odd/web";
            ...
            typeswitch(.)
                ...
                case element(publicationStmt) return
                    (
                        ...
                        html:block($config, ., ("tei-publicationStmt2"), date)
                    )
