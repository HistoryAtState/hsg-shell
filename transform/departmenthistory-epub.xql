...
module namespace model="http://www.tei-c.org/pm/models/departmenthistory/epub";
            ...
            return
                    ...
                    case element(note) return
                        if (@rend = 'inline') then
                            ...
                            epub:note($config, ., ("tei-note2", css:map-rend-to-class(.)), ., "foot", @n/string())
                    ...
                    case element(publicationStmt) return
                        (
                            ...
                            epub:block($config, ., ("tei-publicationStmt3", css:map-rend-to-class(.)), date)
                        )
