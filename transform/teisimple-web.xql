(:~
    ...
    ODD: /db/apps/hsg-shell/resources/odd/source/teisimple.odd
 :)
xquery version "3.1";

module namespace model="http://www.tei-c.org/pm/models/teisimple/web";
            ...
            return
                    ...
                    case element(ref) return
                        if (not(@target)) then
                            ...
                            if (not(text())) then
                                html:link($config, ., ("tei-ref2", css:map-rend-to-class(.)), @target, (), (), map {"link": ()})
                            else
                                html:link($config, ., ("tei-ref3", css:map-rend-to-class(.)), ., (), (), map {"link": ()})
