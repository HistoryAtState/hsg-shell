 ...
 * @see tests/specs/historical-documents/prod_frus_landing.spec.js (wdio)
 * @see tests/specs/historical-documents/prod_frus_titles.spec.js (wdio) – dropdown headline
 */
