...
describe('footnote popover', function () {
  ...
  describe('footnote popover looks and behavior on desktop', function () {
    ...
    it('should have a footnote', function () {
      footnoteLink = Page.getElement('#content-inner a.note[href^="#fn\\:"][rel=footnote]');
    ...
    it('footnote popover should appear on hover', function () {
      ...
      footnoteLink.scrollIntoView({behavior: "smooth", block: "center", inline: "center"});
      Page.pause(2000);
      footnoteLink.moveTo(1,1);
      Page.pause(2000);
    ...
    it.skip('footnote popover should disappear when another one appears', function () {
      ...
      footnotes[0].scrollIntoView({behavior: "smooth", block: "center", inline: "center"});
      footnotes[0].scrollIntoView({behavior: "smooth", block: "center", inline: "center"});
      Page.pause(1000);
      footnotes[0].moveTo(1,1);
      Page.waitForVisible('.popover');
      const popoverText = Page.getElementText('.popover');
      assert.equal(Page.getElement('.popover').isDisplayed(), true);
      footnotes[1].scrollIntoView({behavior: "smooth", block: "center", inline: "center"});
      Page.pause(1000);
      footnotes[1].moveTo(1,1);
      Page.pause(100);
      assert.equal(Page.getElement('.popover').isDisplayed(), true);
    ...
    it.skip('footnote popover should disappear when the user clicks on its link', function () {
      assert.equal(Page.getElement('.popover').isDisplayed(), false);
      Page.getElement('#content-inner a.note[href^="#fn\\:"][rel=footnote]').scrollIntoView({behavior: "smooth", block: "center", inline: "center"});
      Page.pause(1000);
      Page.getElement('#content-inner a.note[href^="#fn\\:"][rel=footnote]').moveTo(1,1);
      Page.waitForVisible('.popover');
      assert.equal(Page.getElement('.popover').isDisplayed(), true);
      Page.pause(100);
